...
# ------------------------------------------------------------------------------
def Initialize(pclv):
    global clv, AntDongle, devTrainer
    clv          = pclv
    AntDongle    = False
    devTrainer   = False
...
#
# Output:       devTrainer, AntDongle
#
# Returns:      True if TRAINER and DONGLE found
# ------------------------------------------------------------------------------
def LocateHW(self):
    global devTrainer, AntDongle, GetTrainerMsg
    ...
    if AntDongle and AntDongle.OK:             # pylint: disable=maybe-no-member
        pass
    else:
